...
after any backend/Python change. Both are gitignored build outputs — nothing
here gets committed.
...
Produces a signed-nothing (Phase 3 will add code signing), double-clickable
...
- `release/FishEye-<version>-arm64.dmg` — what you'd actually hand to a user
...
Currently unsigned: macOS Gatekeeper will show an "unidentified developer"
